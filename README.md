...
3. **Credenciales Hardcodeadas**: Visually confirmed and successfully replaced remaining fallback defaults (`minio123` and `admin/admin`) with their respective secure environment mapping.
