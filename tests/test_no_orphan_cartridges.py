...
def test_remaining_cartridge_dirs_are_deployed_or_profiled():
    ...
    assert cartridge_dirs == {"hubspot", "replicon", "sap_hcm", "sap_s4hana", "sap_successfactors"}
    assert {"replicon", "hubspot", "sap-hcm", "sap-s4hana", "sap-successfactors"}.issubset(service_names)
