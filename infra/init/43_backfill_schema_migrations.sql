...
FROM (VALUES
    ...
    ('13_data_catalog.sql'),
    ('13_rbac_models.sql'),
    ('14_rag_sources_kind.sql'),
    ('14_token_usage_cache_columns.sql'),
    ('15_cartridge_assistant_hints.sql'),
    ('16_audit_events.sql'),
    ('16_escalation_notify.sql'),
    ('17_agents.sql'),
    ('17_login_security.sql'),
    ('18_entity_scheduler.sql'),
    ('18_sessions_extended.sql'),
    ('19_entity_dag_params.sql'),
    ('19_operational_stability_hotfix.sql'),
    ('20_dag_role_and_platform.sql'),
    ('20_sap_cartridges_seed.sql'),
    ('21_cartridge_dag_params_example.sql'),
    ('21_drop_master_layer.sql'),
    ...
    ('59_platform_shared_dags_seed.sql'),
    ('60_rag_embedding_dim_768.sql'),
    ('61_replicon_projectdetail_dag_fix.sql'),
    ('62_vpn_tokens.sql'),
    ('63_escalation_notify.sql'),
    ('64_drop_master_layer.sql')
) AS m(filename)
