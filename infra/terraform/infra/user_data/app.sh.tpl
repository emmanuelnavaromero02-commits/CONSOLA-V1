...
APP_ENV=production
COOKIE_SECURE=true
CONSOLE_URL=https://${public_console_domain}
WORKSPACE_PUBLIC_URL=https://${public_workspace_domain}
APP_BASE_URL=https://${public_console_domain}
AIRFLOW_PUBLIC_URL=http://$APP_PRIVATE_IP:8082
SUPERSET_PUBLIC_URL=http://$APP_PRIVATE_IP:8088
ALLOWED_ORIGINS=https://${public_console_domain},https://${public_workspace_domain}
