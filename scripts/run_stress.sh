...
STRESS_USERS="${OMEGA_STRESS_USERS:-10}"
STRESS_SPAWN_RATE="${OMEGA_STRESS_SPAWN_RATE:-2}"
STRESS_RUN_TIME="${OMEGA_STRESS_RUN_TIME:-2m}"
...
ENABLE_WRITES="${OMEGA_STRESS_ENABLE_WRITES:-0}"
