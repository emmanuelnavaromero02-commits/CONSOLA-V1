...
def _flags(files: list[str]) -> dict[str, bool | str]:
    ...
    infra = _any(files, r"^infra/", r"^\.github/workflows/", r"^scripts/ci_(?:changed_areas|control_room_paths)\.py$", r"^scripts/gcp/", r"^scripts/(wait_for_health|smoke|production|run-e2e|v1_stress)")
