...
INPUT_FILE   = "VO_PRD_KPI_PROJECT_AUDIT Daily.csv"  # se busca en s3://{minio_bucket}/uploads/replicon/in/
CARTRIDGE_ID = "replicon"    # dominio/fuente  →  raw/{CARTRIDGE_ID}/{ENTITY}/...
ENTITY       = "ProjectAudit"    # nombre de la entidad/tabla destino
    ...
    try:
        requests.post(
            ...
            json={"tool": "pipeline_run_save",
                  "args": {"dag_id": "replicon_projects_audit",
...
@dag(
    dag_id='replicon_projects_audit',
