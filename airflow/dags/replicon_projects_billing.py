...
INPUT_FILE   = "BD EUSC_WIP.xlsx"  # nombre del archivo, se busca en s3://{minio_bucket}/uploads/replicon/in/
CARTRIDGE_ID = "replicon"    # dominio/fuente  →  raw/{CARTRIDGE_ID}/{ENTITY}/...
ENTITY       = "ProjectBilling"    # nombre de la entidad/tabla destino
FILE_FORMAT  = "excel"        # "csv" o "excel"
...
@dag(
    dag_id='replicon_projects_billing',
