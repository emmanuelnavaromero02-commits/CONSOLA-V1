...
class Settings(BaseSettings):
    app_name: str = "sap_fi_co"

    # SAP FI/CO Finanzas API
    sap_fi_co_base_url:      str   = "https://na5.sap_fi_co.com/analytics"
    sap_fi_co_api_token:     str | None = None
    sap_fi_co_poll_interval: float = 2.0
    sap_fi_co_poll_timeout:  int   = 300
