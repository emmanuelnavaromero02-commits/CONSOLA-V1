...
class Settings(BaseSettings):
    ...
    sap_successfactors_base_url:      str   = "https://na5.sap_successfactors.com/analytics"
    sap_successfactors_api_token:     str | None = None
    sap_successfactors_poll_interval: float = 2.0
    sap_successfactors_poll_timeout:  int   = 300
