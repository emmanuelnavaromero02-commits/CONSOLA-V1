...
Uso:
    ...
    token = get_setting("sap_successfactors_token", default="", env_fallback="SAP_SUCCESSFACTORS_TOKEN")
"""
...
_INTERNAL_KEY = os.environ.get("INTERNAL_API_KEY_SAP_SUCCESSFACTORS_TO_CONSOLE", "")
...
def _fetch_from_console(key: str) -> str | None:
    ...
    try:
        ...
        headers = {"x-api-key": _INTERNAL_KEY, "x-internal-service": "cartridge-sap_successfactors"}
...
def get_setting(key: str, default: str = "", env_fallback: str | None = None) -> str:
    ...
    Args:
        key: nombre del setting en system_settings (ej. 'sap_successfactors_token').
