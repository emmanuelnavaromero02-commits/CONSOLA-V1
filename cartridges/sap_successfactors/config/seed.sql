...
VALUES (
    'sap_successfactors', 'SAP SuccessFactors HXM', '1.0.0', 'SAP SuccessFactors Human Experience Management — extrae datos de Empleados, Posiciones, Departamentos, y Módulos de Talento (Candidatos, Objetivos, Desempeño).', 'dag-based', 'cartridge', 'raw/sap_successfactors/{entity}/load_date={date}/'
