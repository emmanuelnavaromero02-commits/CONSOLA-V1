-- sap_successfactors_userskill_latest  (silver)  cartridge: sap_successfactors
-- sources: ["raw/sap_successfactors/UserSkill"]
-- description: Skills/proficiencies por empleado cuando UserSkill existe en el tenant.

WITH raw AS (
    SELECT *
    FROM read_parquet('s3://{bucket}/raw/sap_successfactors/UserSkill/**/*.parquet',
