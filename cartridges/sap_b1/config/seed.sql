...
VALUES
    ...
    ('sap_b1', 'OSPP', 'Special prices (OSPP)', 'Special prices per business partner and item (price, currency, discount, validity).', 'full', NULL, NULL, 5000, 'ItemCode,CardCode', NULL, 'sap_b1_extract', TRUE, 'manual'),
    ('sap_b1', 'OSRI', 'Serial numbers (OSRI)', 'Serial number master: item, internal and supplier serial, warehouse, status and dates (legacy serial table, validate in HANA).', 'full', NULL, NULL, 5000, 'ItemCode,SysSerial', NULL, 'sap_b1_extract', TRUE, 'manual'),
    ('sap_b1', 'SRI1', 'Serial number transactions (SRI1)', 'Serial numbers per document line, Direction 0 in / 1 out (legacy serial table, validate in HANA).', 'full', NULL, NULL, 5000, 'ItemCode,SysSerial,LineNum', NULL, 'sap_b1_extract', TRUE, 'manual'),
