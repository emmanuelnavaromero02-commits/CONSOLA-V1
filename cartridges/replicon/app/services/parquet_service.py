...
def write_parquet_and_upload(
    ...
    # Build the URI from the configured bucket so dev (`lakehouse`) and AWS
    # (`modecissions-lakehouse-XXXXXX`) deployments don't end up writing to
    # one bucket while the lineage row points at another.
