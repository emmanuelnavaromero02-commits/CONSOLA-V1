...
def _fetch_from_console(key: str) -> str | None:
    if not _INTERNAL_KEY:
        return None
    try:
        # Sprint v1.12: console's verify_internal_api_key now whitelists
        # "cartridge-<name>" explicitly with its own pair key. Send the
        # cartridge-specific service identifier instead of impersonating
        # airflow.
        headers = {"x-api-key": _INTERNAL_KEY, "x-internal-service": "cartridge-replicon"}
