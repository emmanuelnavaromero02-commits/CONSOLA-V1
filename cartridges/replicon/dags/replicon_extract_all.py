...
def _get_connection(conn_id: str) -> tuple[str, str]:
    ...
    Sprint v1.40: see comment in replicon_extract.py:_get_connection.
    Same contract — call console's vault reveal endpoint with the
    cartridge-to-console pair key, get back base_url + token.
    """
    import os
    import requests
