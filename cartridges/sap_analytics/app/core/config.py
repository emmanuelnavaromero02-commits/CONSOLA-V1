...
class Settings(BaseSettings):
    app_name: str = "sap_analytics"

    # SAP Analytics API
    sap_analytics_base_url:      str   = "https://na5.sap_analytics.com/analytics"
    sap_analytics_api_token:     str | None = None
    sap_analytics_poll_interval: float = 2.0
    sap_analytics_poll_timeout:  int   = 300
