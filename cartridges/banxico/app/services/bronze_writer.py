...
class BronzeWriter:
    ...
    def write_batch(
        ...
        *,
        ...
        if existing:
            ...
            raise ImmutableBatchConflict("complete Banxico batch already exists with different hashes")
    ...
    def _matching_existing(self, key: str, sha: str):
        ...
        if stat.checksum_sha256 != sha:
            raise ImmutableBatchConflict(f"published Banxico object differs: {key}")
        return stat
