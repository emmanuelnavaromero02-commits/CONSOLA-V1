...
def run_series_observations(
    *,
    ...
    client: BanxicoClient | None = None,
    ...
    client = client or BanxicoClient(conn_id=conn_id, security_context=security_context)
...
def _manifest(
    ...
    final_prefix = (
        f"raw/banxico/{entity}/tenant_id={tenant_id}/workspace_id={workspace_id}/"
        f"load_date={load_date}/batch_id={run_id}/"
    )
    staging_prefix = (
        f"raw/banxico/_staging/{entity}/tenant_id={tenant_id}/workspace_id={workspace_id}/"
        f"load_date={load_date}/batch_id={run_id}/"
    )
    return {
        "manifest_version": 1,
...
def _provenance(entity: str, req_hash: str, payload_hash: str, run_id: str, tenant_id: str, workspace_id: str) -> dict[str, str]:
    return {
        ...
        "_source_url": "https://www.banxico.org.mx/SieAPIRest/service/v1",
        "_source_host": "www.banxico.org.mx",
        "_endpoint": entity,
