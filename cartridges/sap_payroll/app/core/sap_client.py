...
class SapPayrollClient:
    def __init__(self):
        self.base_url = settings.sap_payroll_base_url
        self.auth = (settings.sap_payroll_user, settings.sap_payroll_pass)
        self.timeout = 120.0
        self.headers = {
            "Accept": "application/json",
            "sap-client": settings.sap_payroll_client
        }
