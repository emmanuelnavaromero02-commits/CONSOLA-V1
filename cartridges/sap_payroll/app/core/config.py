...
class Settings(BaseSettings):
    app_name: str = "sap_payroll"

    # SAP Payroll API
    sap_payroll_base_url:      str   = "https://na5.sap_payroll.com/analytics"
    sap_payroll_api_token:     str | None = None
    sap_payroll_poll_interval: float = 2.0
    sap_payroll_poll_timeout:  int   = 300
