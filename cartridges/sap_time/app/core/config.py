...
class Settings(BaseSettings):
    app_name: str = "sap_time"

    # Replicon API
    sap_time_base_url:      str   = "https://na5.sap_time.com/analytics"
    sap_time_api_token:     str | None = None
    sap_time_poll_interval: float = 2.0
    sap_time_poll_timeout:  int   = 300
