...
class Settings(BaseSettings):
    app_name: str = "sap_checkin"

    # SAP Check-In Empleados API
    sap_checkin_base_url:      str   = "https://na5.sap_checkin.com/analytics"
    sap_checkin_api_token:     str | None = None
    sap_checkin_poll_interval: float = 2.0
    sap_checkin_poll_timeout:  int   = 300
