...
class SapCheckinClient:
    def __init__(self):
        self.base_url = settings.sap_checkin_base_url
        self.auth = (settings.sap_checkin_user, settings.sap_checkin_pass)
        self.timeout = 120.0
        self.headers = {
            "Accept": "application/json",
            "sap-client": settings.sap_checkin_client
        }
