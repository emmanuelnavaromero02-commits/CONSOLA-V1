...
Uso:
    ...
    token = get_setting("sap_s4hana_token", default="", env_fallback="SAP_S4HANA_TOKEN")
"""
...
_INTERNAL_KEY = os.environ.get("INTERNAL_API_KEY_SAP_S4HANA_TO_CONSOLE", "")
...
def _fetch_from_console(key: str) -> str | None:
    ...
    try:
        ...
        headers = {"x-api-key": _INTERNAL_KEY, "x-internal-service": "cartridge-sap_s4hana"}
...
def get_setting(key: str, default: str = "", env_fallback: str | None = None) -> str:
    ...
    Args:
        key: nombre del setting en system_settings (ej. 'sap_s4hana_token').
