...
class Settings(BaseSettings):
    ...
    # Replicon API
    sap_s4hana_base_url:      str   = "https://na5.sap_s4hana.com/analytics"
    sap_s4hana_api_token:     str | None = None
    sap_s4hana_poll_interval: float = 2.0
    sap_s4hana_poll_timeout:  int   = 300
