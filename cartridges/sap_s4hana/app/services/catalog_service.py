...
CARTRIDGE_META = {
    ...
    "version":     "1.0.0",
    "description": (
        "ERP core — business partners, clientes, proveedores, ventas, "
        "compras, contabilidad y journal entries."
    ),
    "pattern":     "dag-based",
    "category":    "cartridge",
    "bronze_path": "raw/sap_s4hana/{entity}/load_date={date}/",
}
...
def _seed_if_empty() -> None:
    ...
    try:
        ...
        logger.exception("Failed to seed SAP S/4HANA catalog from YAML")
        raise
