...
// The csrf_token cookie is issued by console at login (NOT HttpOnly) and
// shared by domain. Echo it back as X-CSRF-Token on every mutation so the
// backend's require_csrf check passes.
