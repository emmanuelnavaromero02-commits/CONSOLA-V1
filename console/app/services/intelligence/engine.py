...
async def run_intelligence(
    ...
    *,
    ...
    for dataset in sorted(dataset_filter - contract_datasets):
        skipped.append(
            {
    ...
    for contract in contracts:
        ...
        for metric in metrics:
            ...
            if (
                ...
                and metric_artifacts
                and not metric.get("simulation_template")
            ):
                skipped.append(
                    {
                        "cartridge_id": contract.get("cartridge"),
                        "dataset": dataset,
                        "metric": metric.get("id"),
                        "status": "missing_simulation_template",
                        "reason": "automatic Monte Carlo requires metric.simulation_template",
                    }
                )
