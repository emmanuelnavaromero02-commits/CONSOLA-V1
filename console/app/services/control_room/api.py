...
async def sap_successfactors_gold_kpis(user: dict | None) -> dict[str, Any]:
    ...
    employee_rows = await query_gold_dataset_rows(sf_gold_datasets["employee_360"], user, 5000)
    company_rows = await query_gold_dataset_rows(sf_gold_datasets["headcount_by_company"], user, 1000)
    location_rows = await query_gold_dataset_rows(sf_gold_datasets["headcount_by_location"], user, 1000)
    department_rows = await query_gold_dataset_rows(sf_gold_datasets["headcount_by_department"], user, 1000)
