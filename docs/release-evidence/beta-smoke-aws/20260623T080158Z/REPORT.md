...
|---|---|---|---|
| public-alb | public /healthz | PASS | status=200 version=1.45.120-beta expected=1.45.120-beta |
...
| internal-ec2 | SSM command completed | PASS | command_id=3f97d338-ed41-439e-9cfc-44314d5efc35 response_code=0 |
| internal-ec2 | host VERSION file | PASS | path=/opt/modecissions/VERSION version=1.45.120-beta expected=1.45.120-beta |
| internal-ec2 | DEPLOY_REF matches expected | PASS | DEPLOY_REF=v1.45.120-beta expected=v1.45.120-beta |
| internal-ec2 | IMAGE_TAG matches expected | PASS | IMAGE_TAG=v1.45.120-beta expected=v1.45.120-beta |
| internal-ec2 | APP_ENV captured | PASS | APP_ENV=production |
| internal-ec2 | remote git ref captured | PASS | head=805dfbed describe=v1.45.120-beta |
...
| internal-ec2 | internal /healthz | PASS | status=200 version=1.45.120-beta expected=1.45.120-beta |
