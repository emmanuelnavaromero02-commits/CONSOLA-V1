...
docker run --rm \
  ...
  ghcr.io/emmanuelnavaromero02-commits/mc:RELEASE.2024-11-21T17-21-54Z sh -c "
...
image: ghcr.io/emmanuelnavaromero02-commits/minio:RELEASE.2025-XX-XX...   # rebuilt from source with mirror-minio.yml first
```
